...
namespace Litehtml
{
    ...
    public class html_tag : element
    {
        ...
        protected void parse_background()
        {
            ...
            _bg._attachment = (background_attachment)html.value_index(
            ...
            // parse background_attachment
            _bg._repeat = (background_repeat)html.value_index(
            ...
            _bg._clip = (background_box)html.value_index(
                get_style_property("background-clip", false, "border-box"),
                types.background_box_strings, (int)background_box.border_box);

            // parse background_origin
            _bg._origin = (background_box)html.value_index(
                get_style_property("background-origin", false, "padding-box"),
                types.background_box_strings, (int)background_box.content_box);
            ...
            if (!string.IsNullOrEmpty(_bg._image))
                doc.container.load_image(_bg._image, string.IsNullOrEmpty(_bg._baseurl) ? null : _bg._baseurl, null, true);
        }
