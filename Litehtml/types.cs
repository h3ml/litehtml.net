...
namespace Litehtml
{
    ...
    public partial struct position : Rect
    {
        ...
        public bool is_point_inside(int x, int y, int z) =>
            x >= left && x <= right &&
            y >= top && y <= bottom &&
            z >= front && z <= back; //:h3ml
    }
    ...
    public struct media_features
    {
        ...
        public int depth;           //:h3ml // (pixels) The depth of the targeted display area of the output device. For continuous media, this is the depth of the viewport including the size of a rendered scroll bar (if any). For paged media, this is the depth of the page box.
        ...
        public int device_depth;    //:h3ml // (pixels) The depth of the rendering surface of the output device. For continuous media, this is the depth of the screen. For paged media, this is the depth of the page sheet size.
